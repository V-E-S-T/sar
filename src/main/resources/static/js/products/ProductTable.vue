  ...
  >
    <template v-slot:top>
      <v-toolbar
          flat
      >
        <v-toolbar-title>Amazon products</v-toolbar-title>
        <v-divider
            class="mx-4"
            inset
            vertical
...
export default {
  data: () => ({
    ...
    productHeaders: [
      ...
      { title: 'ratingCount', value: 'ratingCount' },
      { title: 'totalRatings', value: 'totalRatings' },
      { title: 'totalReviews', value: 'totalReviews' },
