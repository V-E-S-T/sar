...
public class ProductService {
    ...
    private String searchReferenceByAsin(String asin) {
        ...
        Document searchDoc = ParserUtil.getHTMLDocument("https://www.amazon.com/s?k=asin+" + asin);
        Optional.ofNullable(searchDoc.selectFirst("div[data-asin=\"" + asin + "\"] a")).ifPresent(
